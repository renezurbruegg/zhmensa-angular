...
const routes: Routes = [  { path: 'all', component: AllMenusMensaComponent },{ path: 'favorites', component: FavoriteMensaComponent }, { path: 'mensa/:id', component: MensaComponentComponent }];
